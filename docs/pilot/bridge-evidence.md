...
Wave 3 catalogue passed in PR #22 CI run 31657999348, artifact 9165101505.
...
|---|---|---|
| Fresh install makes no catalogue request | Passed live in `scripts/section6_live_bridge_proof.py`: after unsubscribe, a returning run made zero catalogue fetches | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Explicit consent performs one catalogue request | Passed live in `scripts/section6_live_bridge_proof.py`: the subscribed returning run made exactly one catalogue fetch | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Real catalogue URL is reachable | Passed live: `https://heydex.ai/catalogue/dex-lens/v2.json` returned 200, 175,296 bytes, SHA-256 `37c100548062be01cad99718402492885ede722365e270898850bb4196863fce`, and was byte-identical to Core release v1.96.1 | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Signed catalogue verifies locally | Passed live: Lens verified Core release v1.96.1 and the heydex.ai-served copy with `default_keyring()` | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
...
| Exact release identity matches | Passed live: release, key, exact byte hash, catalogue version 3, 55-capability ordered ID set, and 11-job count all matched the release manifest | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Network evidence is complete | Passed live: packet capture was ready, exited cleanly, received all 904 captured packets, observed 900 non-loopback packets, and dropped zero packets | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Tampered or mismatched catalogue fails closed | Passed live for signature tampering in `scripts/section6_live_bridge_proof.py`; exact-release mismatch is behaviorally tested and writes a structured failed receipt | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
...
| Minimal first-time host gets a shelf and brief | Passed live in the canonical `scripts/section6_live_bridge_proof.py` journey | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Customised Claude host gets a shelf and brief | Passed live in the canonical `scripts/section6_live_bridge_proof.py` journey | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Guided/export-assisted host gets a shelf and brief | Passed live in the canonical `scripts/section6_live_bridge_proof.py` journey | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Three briefs are host-appropriate | Passed live: minimal, customised, and guided/export briefs contain host-specific context and are non-identical | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Subscription loop across runs | Passed live in `scripts/section6_live_bridge_proof.py`: subscribe, returning one-fetch prompt, park suppression, revoke, and unsubscribed zero-fetch posture | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
...
| Wave 3 capability set exists | Passed live: the real catalogue carries the exact 24 lifecycle / 5 room / 1 active Wave 3 partition, bringing the ordered total to 55; all 90 Wave 3 evidence records remain honestly `supported`, not `verified` | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |
| Live catalogue deploy | Passed live: heydex.ai serves the signed v1.96.1 catalogue from the canonical URL and its bytes match the GitHub release | Attached in PR #22 live-proof run 31657999348, artifact 9165101505 |

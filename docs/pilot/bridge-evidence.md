...
release in PR #21 CI run 31620154658, artifact 9150895971. Local Lens-side proof
...
| Real catalogue URL is reachable | Passed live: `https://heydex.ai/catalogue/dex-lens/v2.json` returned 200, 83,995 bytes, SHA-256 `79f3c2271f315493fb1f13b11e809e7899562c8a9aebb71cb9ff78d1b7cd89c6`, and was byte-identical to Core release v1.95.2 | Attached in PR #21 live-proof run 31620154658, artifact 9150895971 |
| Signed catalogue verifies locally | Passed live: Lens verified Core release v1.95.2 and the heydex.ai-served copy with `default_keyring()` | Attached in PR #21 live-proof run 31620154658, artifact 9150895971 |
...
| Exact release identity matches | Passed live: release, key, exact byte hash, catalogue version, 25-capability ordered ID set, and 9-job count all matched the release manifest | Attached in PR #21 live-proof run 31620154658, artifact 9150895971 |
...
| Live catalogue deploy | Passed live: heydex.ai serves the signed catalogue from the canonical URL | Byte-identity proof attached in PR #21 live-proof run 31620154658, artifact 9150895971 |
...
- `subscribed_prompt_rendered: false` in artifact 9150895971 is correct. The current

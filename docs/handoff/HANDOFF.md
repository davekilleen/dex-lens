...
**Status:** Planning is decision-complete and the D0 response to the Fable critique is recorded on Dex issue #347 (7 August 2026; signed pack hash below). Source of truth: GitHub issues davekilleen/Dex #347 (open parent Wayfinder map) and #348–#357 (closed children, each resolved by a "## Resolution" comment). This pack was assembled 2026-08-07 from the verbatim decision inventory (`sources/decisions.md`), the machinery-reuse research and drift audit (`sources/machinery.md`), and the testable security gates (`sources/gates.md`). M1 and M2 are merged; the M3 source-alpha baseline is merged in PR #4 and its closure proofs remain tracked here.
...
**What this pack is, and is not (two-stage handoff interpretation — D0 recorded):** #357's bar ("implementation begins only after one reviewed handoff pack contains … the observed pilot evidence") and R7's fail-closed rule are literally circular for a product whose pilot comes after implementation. D0 records this pack as the build-authorization pack for M1–M6 at pilot scope; the M6 completeness pack remains the handoff bar for expansion and real-user automated adaptation beyond the pilot:
...
**D0 record:** Dave recorded acceptance of G1–G6 and R1–R7 as binding criteria, the two-stage interpretation above, the #354 attachments-vs-G4 resolution (raw personal material dropped for the pilot), and the strict-majority P1 threshold (N=6→4, 7→4, 8→5) on Dex #347 on 7 August 2026. The signed handoff-pack hash is `de01cfb1794790a90e34010198063a8449631e32ec450b8f4368cc21ab7bf6f5`. This record authorizes repository implementation at pilot scope; it does not imply deployment, publication, Core adoption, or a successful pilot.
...
After #357 closed, an independent Fable critique on #347 (2026-08-06T17:31:05Z) hardened the plan without weakening its direction. D0's recorded response accepts the gates and R-items below as binding without claiming a pilot outcome. The critique states the core direction "remains sound and should not be weakened" and adds:
...
Per #357's handoff bar, the pack carries the Fable critique **plus the decisions made in response to it**. D0 records that **all six gates and all seven R-items are accepted as binding acceptance criteria and scheduled into milestones M1–M6 below**, alongside the two-stage handoff interpretation, the F3 Card-attachment resolution, and the P1 threshold reading. The M6 R7 completeness pack remains required before expansion; no pilot success is implied by this planning record.
...
- **Raw-material attachments (#354 vs G4 — D0 resolution):** #354 permits raw prompts/files/conversations/histories/personal examples as separately-consented opt-in attachments; G4 rejects raw personal examples from the Card schema by construction. D0 resolves this for the pilot: **the Card schema itself never carries raw personal examples — G4 holds absolutely — and attachments are dropped for the pilot**. A future separate attachment channel would need its own G2 inventory, disclosure manifest, immutable-version consent, and withdrawal propagation; M5 keeps the field unrepresentable in the pilot payload.
...
0. **D0 — Recorded on #347 (7 August 2026; no longer blocking).** Dave recorded (a) acceptance of G1–G6 and R1–R7 as binding acceptance criteria scheduled into M1–M6; (b) the two-stage handoff interpretation (this pack authorizes M1–M6 at pilot scope; the M6 R7 completeness pack is the handoff bar for expansion and real-user automated adaptation beyond the pilot); (c) G4 absolute on the Card schema with raw attachments dropped for the pilot; and (d) the strict-majority P1 threshold (N=6→4, 7→4, 8→5). The decision is recorded against signed pack hash `de01cfb1794790a90e34010198063a8449631e32ec450b8f4368cc21ab7bf6f5`. This does not claim deployment, publication, Core adoption, or pilot success.
